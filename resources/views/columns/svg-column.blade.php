...
<style>
    ...
    @media (prefers-color-scheme: dark) {
        .svg-filter {
            filter: invert(100%) !important; /* Example: Inverts colors. Adjust as needed. */
            color: black; /* for alt text, because it gets inverted it then is correct again */
        }
    }
</style>
<div
                    ...
                    <img
                        ...
                        {{
                            $getExtraImgAttributeBag()
                                ->class([
                                    'svg-filter dark:filter-invert-svg max-w-none object-cover object-center',
